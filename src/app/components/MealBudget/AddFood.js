...
export function AddFood() {
  ...
  return (
    <div className="bg-white rounded-lg p-6 shadow-card">
      <h3 className="text-xl font-semibold text-gray-900 mb-4">Add Food</h3>
        ...
        <div className="relative flex flex-row items-center space-x-2">
            ...
            {loading ? (
              <div role="status">
                <div role="status">
                  <svg
                    aria-hidden="true"
                    class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-300 fill-indigo-600"
                    viewBox="0 0 100 101"
                    fill="none"
              ...
              <div className="flex row items-center justify-center space-x-2"></div>
            )}
          </div>
          ...
          type="submit"
            ...
            className={
              loading
                ? "invisible"
                : "bg-indigo-600 text-white px-2 py-2 rounded-md"
            }
          >
            Search
          </button>
